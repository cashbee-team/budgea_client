...
# Unit tests for BudgeaClient::InlineResponse2005
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2005' do
  before do
    # run before each test
    @instance = BudgeaClient::InlineResponse2005.new
  end
  ...
  describe 'test an instance of InlineResponse2005' do
    it 'should create an instance of InlineResponse2005' do
      expect(@instance).to be_instance_of(BudgeaClient::InlineResponse2005)
    end
  end

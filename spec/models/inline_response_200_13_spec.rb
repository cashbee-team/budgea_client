...
# Unit tests for BudgeaClient::InlineResponse20013
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse20013' do
  before do
    # run before each test
    @instance = BudgeaClient::InlineResponse20013.new
  end
  ...
  describe 'test an instance of InlineResponse20013' do
    it 'should create an instance of InlineResponse20013' do
      expect(@instance).to be_instance_of(BudgeaClient::InlineResponse20013)
    end
  end

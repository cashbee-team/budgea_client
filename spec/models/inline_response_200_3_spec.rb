...
# Unit tests for BudgeaClient::InlineResponse2003
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2003' do
  before do
    # run before each test
    @instance = BudgeaClient::InlineResponse2003.new
  end
  ...
  describe 'test an instance of InlineResponse2003' do
    it 'should create an instance of InlineResponse2003' do
      expect(@instance).to be_instance_of(BudgeaClient::InlineResponse2003)
    end
  end

...
# Unit tests for BudgeaClient::InlineResponse2004
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2004' do
  before do
    # run before each test
    @instance = BudgeaClient::InlineResponse2004.new
  end
  ...
  describe 'test an instance of InlineResponse2004' do
    it 'should create an instance of InlineResponse2004' do
      expect(@instance).to be_instance_of(BudgeaClient::InlineResponse2004)
    end
  end

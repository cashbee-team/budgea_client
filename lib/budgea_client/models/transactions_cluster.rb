...
module BudgeaClient
  ...
  class TransactionsCluster
    ...
    attr_accessor :mean_amount

    attr_accessor :median_increment
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mean_amount')
        self.mean_amount = attributes[:'mean_amount']
      end

      if attributes.has_key?(:'median_increment')
        self.median_increment = attributes[:'median_increment']
      end
      ...
      if attributes.has_key?(:'next_date')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          mean_amount == o.mean_amount &&
          median_increment == o.median_increment &&
          enabled == o.enabled &&
    ...
    def hash
      [id, id_account, mean_amount, median_increment, enabled, next_date, wording, id_category, created_by].hash
    end

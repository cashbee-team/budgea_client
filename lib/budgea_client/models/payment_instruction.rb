...
module BudgeaClient
  class PaymentInstruction
    ...
    def self.swagger_types
      {
        ...
        :'currency' => :'PaymentInstructionCurrency',
        :'beneficiary' => :'PaymentInstructionBeneficiary'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'execution_date')
    ...
    def hash
      [reference_id, execution_date_type, label, amount, exec_date, execution_date, currency, beneficiary].hash
    end

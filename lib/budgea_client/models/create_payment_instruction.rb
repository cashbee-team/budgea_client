...
module BudgeaClient
  class CreatePaymentInstruction
    ...
    def self.swagger_types
      {
        ...
        :'exec_date' => :'String',
        :'currency' => :'String',
        :'beneficiary' => :'CreatePaymentInstructionBeneficiary'
      }
    end
    ...
    def hash
      [reference_id, execution_date_type, label, amount, exec_date, currency, beneficiary].hash
    end

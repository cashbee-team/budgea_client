...
module BudgeaClient
  class TransfersApi
    ...
    # @option opts [CreatePayment] :payment Payment definition
    # @return [Payment]
    def payments_post(opts = {})
      data, _status_code, _headers = payments_post_with_http_info(opts)
      data
    end
    ...
    def payments_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TransfersApi.payments_post ...'
      end
      # resource path
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(opts[:'payment'])
      auth_names = ['api_key']
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'Payment')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TransfersApi#payments_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
